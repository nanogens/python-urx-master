...
if __name__ == "__main__":
    ...
    try:
        ...
        while i < 1:
            ...
            # base rotation, rotational lift, elblow lift, wrist lift, finger rotation, ring rotation
            # 1.0 CCW      , -1.0  lift     ,-1.0 lift,   -1.0 lift  , -1.0 rotation  , -1.0 rotation
            rob.movej((6.3, -3.15, 2.1, 6.3, 0, 0), acc=a, vel=v)
            ...
            # base rotation, rotational lift, elblow lift, wrist lift, finger rotation, ring rotation
            # 1.0 CCW      , -1.0  lift     ,-1.0 lift,   -1.0 lift  , -1.0 rotation  , -1.0 rotation
            rob.movej((6.3, -3.15, 2.1, 6.3, 6.3, 0), acc=a, vel=v)
            ...
            # base rotation, rotational lift, elblow lift, wrist lift, finger rotation, ring rotation
            # 1.0 CCW      , -1.0  lift     ,-1.0 lift,   -1.0 lift  , -1.0 rotation  , -1.0 rotation
            rob.movej((6.3, -3.15, 2.1, 6.3, 6.3, 6.3), acc=a, vel=v)
            ...
            # base rotation, rotational lift, elblow lift, wrist lift, finger rotation, ring rotation
            # 1.0 CCW      , -1.0  lift     ,-1.0 lift,   -1.0 lift  , -1.0 rotation  , -1.0 rotation
            rob.movej((6.3, -3.15, 2.1, 6.3, 6.3, 0.0), acc=a, vel=v)
            ...
            # base rotation, rotational lift, elblow lift, wrist lift, finger rotation, ring rotation
            # 1.0 CCW      , -1.0  lift     ,-1.0 lift,   -1.0 lift  , -1.0 rotation  , -1.0 rotation
            rob.movej((6.3, -3.15, 2.1, 6.3, 0.0, 0.0), acc=a, vel=v)
